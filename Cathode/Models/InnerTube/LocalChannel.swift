...
// MARK: - ITChannel conversion

extension LocalChannel {
    /// Converts to the shared ITChannel model used across views and BrowseViewModel.
    public func toChannel() -> ITChannel {
        ITChannel(id: id, title: title, thumbnailURL: thumbnailURL, isSubscribed: true)
    }
}
